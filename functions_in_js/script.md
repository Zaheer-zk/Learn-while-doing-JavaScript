...
In this example, f is the name of the function. (a, b) are the parameters. You can write any logic in the body and finally return a result. You are allowed to return nothing, and it will instead implicitly return undefined.
...
You can use rest syntax to access all the passed arguments as an array. but it will be a critical concept for many problems.
