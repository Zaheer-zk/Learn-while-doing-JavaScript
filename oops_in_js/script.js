...
const zaheer = new Person('zaheer', 1991);
console.log(zaheer);
...
const fareed = new Person('fareed', 2017);
const johran = new Person('johran', 1975);
...
console.log(Person.prototype.isPrototypeOf(fareed));
console.log(Person.prototype.isPrototypeOf(Person));

// .prototyeOfLinkedObjects

Person.prototype.species = 'Homo Sapiens';
console.log(zaheer.species, fareed.species);

console.log(zaheer.hasOwnProperty('firstName'));
console.log(zaheer.hasOwnProperty('species'));
...
const acc1 = new Account('zaheer', 'EUR', 1111);
